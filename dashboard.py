...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'width': '80%', 'padding': '3px', 'font-size': 20, 'textAlignLast': 'center'}
        )
    ]),
...
def update_output_container(selected_statistics, input_year):
    ...
    # elif (input_year and input_statistic =='Yearly Statistics'):
...
# 	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(
                ...
                title="Share of Advertising Expenditure by Vehicle Type"
            )
        )
